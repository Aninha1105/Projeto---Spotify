...
import { faHome, faSearch, faGlobe, faPlus, faBook, faPlusCircle, faPlusMinus, faPlugCircleBolt, faCirclePlus } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="sidebar">
            ...
            <div className="library">
                <div className="library__content">
                    ...
                    <span className="fa fa-plus"><FontAwesomeIcon icon={faPlusCircle} /></span>
                </div>
